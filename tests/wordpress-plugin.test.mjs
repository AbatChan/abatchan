...
check('a section eases open rather than snapping',adminCss.includes('.nika-card__body { display: grid; grid-template-rows: 1fr;')&&adminCss.includes('grid-template-rows: 0fr')&&adminJs.includes("body.className = 'nika-card__body'"));
