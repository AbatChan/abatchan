...
check('a named published page wins over a model route guess',php.includes("$best_path = $published_path")&&php.includes("strpos( $normalize( nika_site_index() ), $normalize( $candidate )")&&php.includes("basename( $published_path )"));
