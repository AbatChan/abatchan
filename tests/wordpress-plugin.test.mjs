...
check('published update manifest matches the plugin version',updateManifest.version==='0.4.3'&&updateManifest.package.endsWith('/nika-site-guide-0.4.3.zip')&&php.includes("const NIKA_VERSION = '0.4.3'"));
...
check('provider errors are spaced away from the suggestion form',adminCss.includes('.nika-generator-status { display: none; margin: 26px 0 0;'));
