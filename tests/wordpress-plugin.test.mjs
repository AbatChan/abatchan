...
check('published update manifest matches the plugin version',updateManifest.version==='0.5.7'&&updateManifest.package.endsWith('/nika-site-guide-0.5.7.zip')&&php.includes("const NIKA_VERSION = '0.5.7'"));
