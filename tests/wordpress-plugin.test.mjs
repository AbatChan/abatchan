...
check('a jump from the section list reveals a collapsed section',adminJs.includes("querySelector(`.nika-jump a[href=\"#${id}\"]`)")&&adminJs.includes('jump?.addEventListener'));
