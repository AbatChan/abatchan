...
check('published update manifest matches the plugin version',updateManifest.version==='0.4.1'&&updateManifest.package.endsWith('/nika-site-guide-0.4.1.zip')&&php.includes("const NIKA_VERSION = '0.4.1'"));
