...
check('published update manifest matches the plugin version',updateManifest.version==='0.4.6'&&updateManifest.package.endsWith('/nika-site-guide-0.4.6.zip')&&php.includes("const NIKA_VERSION = '0.4.6'"));
