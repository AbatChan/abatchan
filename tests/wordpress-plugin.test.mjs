...
check('published update manifest matches the plugin version',updateManifest.version==='0.5.5'&&updateManifest.package.endsWith('/nika-site-guide-0.5.5.zip')&&php.includes("const NIKA_VERSION = '0.5.5'"));
