...
(function assistantV2(){
  ...
  // what the visitor is reading the answer in. Everything the guide paints onto
  // the page sits below them: the label pill is page decoration and rides its
  // target's own stacking, so it needs only to clear that target's content —
  // a near-maximum z-index made it float over the conversation instead.
