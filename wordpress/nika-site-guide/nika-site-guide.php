		...
		<form action="options.php" method="post" class="nika-shell"><?php settings_fields( 'nika_group' ); ?>
			<main class="nika-main">
				...
				<section class="nika-card" id="nika-guardrails">
					...
					<div class="nika-grid nika-grid--4"><label class="nika-field"><span><?php esc_html_e( 'Per visitor / hour', 'nika-site-guide' ); ?><?php echo nika_help( __( 'Example: 20 lets one visitor ask up to 20 questions before the hourly reset.', 'nika-site-guide' ) ); ?></span><input id="nika-limit" name="<?php echo esc_attr( NIKA_OPTION ); ?>[hourly_limit]" type="number" min="1" max="1000" value="<?php echo esc_attr( $s['hourly_limit'] ); ?>"></label><label class="nika-field"><span><?php esc_html_e( 'Whole site / day', 'nika-site-guide' ); ?><?php echo nika_help( __( 'Example: 500 a day is at most 15,000 requests in a 30-day month.', 'nika-site-guide' ) ); ?></span><input name="<?php echo esc_attr( NIKA_OPTION ); ?>[daily_limit]" type="number" min="1" max="100000" value="<?php echo esc_attr( $s['daily_limit'] ); ?>"></label><label class="nika-field"><span><?php esc_html_e( 'Visible characters', 'nika-site-guide' ); ?></span><input name="<?php echo esc_attr( NIKA_OPTION ); ?>[context_characters]" type="number" min="1000" max="20000" step="1000" value="<?php echo esc_attr( $s['context_characters'] ); ?>"><small><?php esc_html_e( 'Example: 12,000 characters is roughly 2,000 words from the current screen.', 'nika-site-guide' ); ?></small></label><label class="nika-field"><span><?php esc_html_e( 'Conversation turns', 'nika-site-guide' ); ?><?php echo nika_help( __( 'Example: 10 keeps about 10 recent question-and-answer exchanges.', 'nika-site-guide' ) ); ?></span><input name="<?php echo esc_attr( NIKA_OPTION ); ?>[history_turns]" type="number" min="1" max="20" value="<?php echo esc_attr( $s['history_turns'] ); ?>"></label></div>
