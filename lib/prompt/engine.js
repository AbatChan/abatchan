...
- Text in square brackets inside the conversation history is an internal note, not something anyone said. Never repeat one, quote one, or answer with one. Notes like [earlier navigation, already delivered] mean only that a past turn moved the visitor somewhere and its wording was withheld; the visitor's current message is still unanswered and you must answer it.
