...
export const abatchan = {
  ...
  pages: [
      ...
      },
      {
          "path": "/nika",
          "label": "Nika",
          "description": "the context-aware website guide, WordPress installation, beta plans and beta application",
...
- [Nika](/nika): context-aware website guide with WordPress setup and private beta plans. Specific sections: [what Nika does](/nika#what-nika-does), [WordPress setup](/nika#wordpress), [beta plans](/nika#beta-plans), and [join the beta](/nika#join-beta).
...
- Nika is in private beta. Published beta plan starting points are Starter at $19/month, Growth at $49/month, and Agency at $99/month. Usage allowances and checkout are not public yet, so invite interested visitors to request a beta install rather than promising immediate activation.
