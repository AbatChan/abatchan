...
- Nika is available to buy as customer-hosted software. Personal is $99 one time for 1 website and a choice of WordPress or Universal. Business is $199 one time for 5 websites, includes both current installers, customer-hosted data and usage, removal of Nika branding, and priority email support. Agency is $399 one time for 25 websites, all current installers, new adapters released during the update term, broader white-label controls, and agency onboarding.
- Recommend the smallest plan that satisfies every stated need. Removing Nika branding alone is included in Business and must not be treated as requiring Agency. Reserve Agency for needs that actually exceed Business, such as more than 5 and up to 25 websites, broader agency white-label controls, agency onboarding, or new adapters released during the update term.
