...
- Do not promise a specific checkout provider until the merchant-of-record migration is live. Do not claim that Shopify or other planned adapters are currently downloadable; the current installers are WordPress and Universal JS plus Node or Docker.
