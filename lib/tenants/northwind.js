...
export const northwind = {
  id: 'northwind',
  siteKey: 'site_northwind_demo',
  // Only domains this tenant controls. A record must never list a domain the
  // customer does not own: the origin list is the whole of what stops a site
  // key being lifted onto someone else's page.
  origins: ['northwindbakery.co.uk', '*.northwindbakery.co.uk'],
  // No content store of its own yet, so it is served from this record alone.
  contactEmail: 'hello@northwindbakery.co.uk',
  ...
  assistantName: 'Poppy',
  assistantSubtitle: 'shop help, backed by Dara',
  avatar: null,
  chips: [
    { label: 'What is baked today?', description: 'See today\'s fresh selection' },
    { label: 'Do you deliver?', description: 'Check areas and delivery times' },
    { label: 'How do I order a cake?', description: 'Review the ordering steps' }
  ],
  ownerName: 'Dara',
