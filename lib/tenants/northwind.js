...
export const northwind = {
  ...
  // example.com is here so the cross-origin path can actually be exercised
  // against a real third-party origin. This tenant is a fixture, not a
  // customer; a real record lists only domains that customer controls.
  origins: ['northwindbakery.co.uk', '*.northwindbakery.co.uk', 'example.com', 'www.example.com'],
  ...
  avatar: null,
  greeting: "Hi, I'm Poppy. Looking for bread, cake or a class?",
  chips: ['What is baked today?', 'Do you deliver?', 'How do I order a cake?', 'Tell me about the classes'],
  ownerName: 'Dara',
