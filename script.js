...
html[data-theme="light"] .site-header,html[data-theme="light"] .mobile-tabs{--glass-tint:rgba(248,249,255,.7);--glass-ring:rgba(52,54,70,.3);--glass-spec:rgba(255,255,255,.96);box-shadow:0 0 0 1px var(--glass-ring),inset 0 1px 0 var(--glass-spec),inset 0 -1px 0 rgba(52,54,70,.12),0 18px 38px rgba(61,63,85,.16)!important}
html[data-theme="light"] .mobile-tabs a{color:rgba(21,21,25,.72)!important;text-shadow:0 1px 0 rgba(255,255,255,.8)}html[data-theme="light"] .mobile-tabs a.active{color:#151519!important;background:rgba(99,102,241,.16)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.92),0 0 0 1px rgba(99,102,241,.28)!important}html[data-theme="light"] .footer-meta{color:#5c5e68}html[data-theme="light"] .footer-meta a{color:#3f414a}
html[data-theme="light"] .social-rail{padding:5px;background:linear-gradient(110deg,rgba(99,102,241,.08),rgba(255,255,255,.62),rgba(90,208,255,.08));border-radius:16px;box-shadow:inset 0 1px 0 rgba(255,255,255,.9),0 8px 28px rgba(72,75,98,.08)}
